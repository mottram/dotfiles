...
/* general settings */
char startpage[241]                     = "http://www.google.co.uk";
char useragent[120]	                    = "Vimprobable2 0.8.1.0";
static const gboolean enablePlugins     = TRUE; /* TRUE keeps plugins enabled */

/* appearance */
char statusbgcolor[]                    = "#eeeeee";            /* background color for status bar */
char statuscolor[]                      = "#888888";            /* color for status bar */
char sslbgcolor[]                       = "#66cc99";            /* background color for status bar with SSL url */
...
static const char statusfont[]          = "monospace normal 8";   /* font for status bar */
...
/* history */
#define             HISTORY_MAX_ENTRIES         2000
...
static Searchengine searchengines[] = {
    ...
    { "pin",         "http://pinboard.in/search/?query=%s&mine=SearchMine" },
};
